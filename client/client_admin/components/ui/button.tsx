...
// Note: Ensure class-variance-authority and @radix-ui/react-slot are installed or remove Slot/cva if not using them.
// For simplicity without extra deps, I'll use standard props approach, but installing cva is better.
// I will assuming standard Tailwind without radis-ui deps for now to keep it lightweight unless requested.
